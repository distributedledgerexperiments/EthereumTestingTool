...
sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.2.30 "./node12/startnode.sh"
...
sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.2.31 "./node13/startnode.sh"
...
sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.2.32 "./node14/startnode.sh"
...
sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.2.33 "./node15/startnode.sh"


cd ../../../transfer/backend/node3/besu_poa/ws_stack_15

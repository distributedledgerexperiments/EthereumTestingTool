...
cd ../../../transfer/backend/node3/geth/chainhammer_stack

tar -cvf client1.tar client1
tar -cvf client2.tar client2
tar -cvf client3.tar client3

sshpass -p Nissan!123 scp -o StrictHostKeyChecking=no client1.tar renault@10.0.1.5:/home/renault
sshpass -p Nissan!123 scp -o StrictHostKeyChecking=no client2.tar renault@10.0.1.6:/home/renault
sshpass -p Nissan!123 scp -o StrictHostKeyChecking=no client3.tar renault@10.0.1.7:/home/renault

rm client1.tar
rm client2.tar
rm client3.tar

sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.1.5 "tar -xvf client1.tar"

sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.1.6 "tar -xvf client2.tar"

sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.1.7 "tar -xvf client3.tar"

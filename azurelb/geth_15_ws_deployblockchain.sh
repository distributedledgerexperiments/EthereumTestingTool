...
sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.2.22 "mv geth node8"
...
sshpass -p Nissan!123 ssh -o StrictHostKeyChecking=no renault@10.0.2.37 "nohup ./client/basestartdocker.sh 1>stdout.txt 2>stderr.txt &"

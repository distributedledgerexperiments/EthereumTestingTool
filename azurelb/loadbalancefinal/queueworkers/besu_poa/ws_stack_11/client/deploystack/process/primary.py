...
from config import RPCaddress, NUMBER_OF_TRANSACTIONS,MONGO_DB,MONGO_PORT, CONTRACT_ADDRESS, CLIENT_THREADS,MONGO_DB_2,MONGO_PORT_2,MONGO_DB_3,MONGO_PORT_3,MONGO_PORT_4,MONGO_PORT_5,MONGO_PORT_6,MONGO_PORT_7,MONGO_PORT_8,MONGO_PORT_9,MONGO_PORT_10,MONGO_PORT_11,MONGO_PORT_12
...
def readfirstData():
  ...
  mongodb_url_4=str(MONGO_DB_3)+":"+str(MONGO_PORT_4)
  mongodb_url_5=str(MONGO_DB_3)+":"+str(MONGO_PORT_5)
  mongodb_url_6=str(MONGO_DB_3)+":"+str(MONGO_PORT_6)
  mongodb_url_7=str(MONGO_DB_3)+":"+str(MONGO_PORT_7)
  mongodb_url_8=str(MONGO_DB_3)+":"+str(MONGO_PORT_8)
  mongodb_url_9=str(MONGO_DB_3)+":"+str(MONGO_PORT_9)
  mongodb_url_10=str(MONGO_DB_3)+":"+str(MONGO_PORT_10)
  mongodb_url_11=str(MONGO_DB_3)+":"+str(MONGO_PORT_11)
  mongodb_url_12=str(MONGO_DB_3)+":"+str(MONGO_PORT_12)
  mongodburls=[mongodb_url,mongodb_url_2,mongodb_url_3,mongodb_url_4,mongodb_url_5,mongodb_url_6,mongodb_url_7,mongodb_url_8,mongodb_url_9,mongodb_url_10,mongodb_url_11,mongodb_url_12]
  resultsets=[]
